var PrestoBundle = (() => {
    ...
    function P(n4) {
        if (null != (n4 = n4.__) && null != n4.__c)
            return (
                (n4.__e = n4.__c.base = null),
                n4.__k.some(function (l6) {
    ...
    function L(n4, l6, u6, t5, i5, r5, o5, e5, f6, c5, a5) {
        var s5,
            ...
            m6 = (t5 && t5.__k) || w,
            b5 = l6.length;
        for (f6 = T(u6, l6, m6, f6, b5), s5 = 0; s5 < b5; s5++)
            null != (p6 = u6.__k[s5]) &&
                ((h6 = (-1 != p6.__i && m6[p6.__i]) || d),
                (p6.__i = s5),
                (_6 = q(n4, p6, h6, i5, r5, o5, e5, f6, c5, a5)),
                (v5 = p6.__e),
                p6.ref && h6.ref != p6.ref && (h6.ref && J(h6.ref, null, p6), a5.push(p6.ref, p6.__c || v5, p6)),
                null == y6 && null != v5 && (y6 = v5),
                (g7 = !!(4 & p6.__u)) || h6.__k === p6.__k ? ((f6 = j(p6, f6, n4, g7)), g7 && h6.__e && (h6.__e = null)) : "function" == typeof p6.type && void 0 !== _6 ? (f6 = _6) : v5 && (f6 = v5.nextSibling),
                (p6.__u &= -7));
        return ((u6.__e = y6), f6);
    }
    function T(n4, l6, u6, t5, i5) {
        var r5,
            ...
            s5 = a5,
            h6 = 0;
        for (n4.__k = new Array(i5), r5 = 0; r5 < i5; r5++)
            null != (o5 = l6[r5]) && "boolean" != typeof o5 && "function" != typeof o5
                ? ("string" == typeof o5 || "number" == typeof o5 || "bigint" == typeof o5 || o5.constructor == String ? (o5 = n4.__k[r5] = x(null, o5, null, null, null)) : g(o5) ? (o5 = n4.__k[r5] = x(S, { children: o5 }, null, null, null)) : void 0 === o5.constructor && o5.__b > 0 ? (o5 = n4.__k[r5] = x(o5.type, o5.props, o5.key, o5.ref ? o5.ref : null, o5.__v)) : (n4.__k[r5] = o5),
                  (f6 = r5 + h6),
                  (o5.__ = n4),
                  (o5.__b = n4.__b + 1),
                  (e5 = null),
                  -1 != (c5 = o5.__i = O(o5, u6, f6, s5)) && (s5--, (e5 = u6[c5]) && (e5.__u |= 2)),
                  null == e5 || null == e5.__v ? (-1 == c5 && (i5 > a5 ? h6-- : i5 < a5 && h6++), "function" != typeof o5.type && (o5.__u |= 4)) : c5 != f6 && (c5 == f6 - 1 ? h6-- : c5 == f6 + 1 ? h6++ : (c5 > f6 ? h6-- : h6++, (o5.__u |= 4))))
                : (n4.__k[r5] = null);
    ...
    function N(n4, l6, u6, t5, i5) {
        var r5, o5;
        n: if ("style" == l6)
            if ("string" == typeof u6) n4.style.cssText = u6;
            else {
            ...
            else if ("width" != l6 && "height" != l6 && "href" != l6 && "list" != l6 && "form" != l6 && "tabIndex" != l6 && "download" != l6 && "rowSpan" != l6 && "colSpan" != l6 && "role" != l6 && "popover" != l6 && l6 in n4)
                try {
                    n4[l6] = null == u6 ? "" : u6;
                    break n;
                }
    ...
    function q(n4, u6, t5, i5, r5, o5, e5, f6, c5, a5) {
        ...
        n: if ("function" == typeof T7)
            try {
                if (
                    ((k5 = u6.props),
                    (x6 = T7.prototype && T7.prototype.render),
                    (M4 = (s5 = T7.contextType) && i5[s5.__c]),
                    ($4 = s5 ? (M4 ? M4.props.value : s5.__) : i5),
                    t5.__c ? (_6 = (h6 = u6.__c = t5.__c).__ = h6.__E) : (x6 ? (u6.__c = h6 = new T7(k5, $4)) : ((u6.__c = h6 = new C(k5, $4)), (h6.constructor = T7), (h6.render = Q)), M4 && M4.sub(h6), h6.state || (h6.state = {}), (h6.__n = i5), (p6 = h6.__d = true), (h6.__h = []), (h6._sb = [])),
                    x6 && null == h6.__s && (h6.__s = h6.state),
                    x6 && null != T7.getDerivedStateFromProps && (h6.__s == h6.state && (h6.__s = m({}, h6.__s)), m(h6.__s, T7.getDerivedStateFromProps(k5, h6.__s))),
                    (v5 = h6.props),
                    (y6 = h6.state),
                    (h6.__v = u6),
                    p6)
                )
                    (x6 && null == T7.getDerivedStateFromProps && null != h6.componentWillMount && h6.componentWillMount(), x6 && null != h6.componentDidMount && h6.__h.push(h6.componentDidMount));
                else {
                    if ((x6 && null == T7.getDerivedStateFromProps && k5 !== v5 && null != h6.componentWillReceiveProps && h6.componentWillReceiveProps(k5, $4), u6.__v == t5.__v || (!h6.__e && null != h6.shouldComponentUpdate && false === h6.shouldComponentUpdate(k5, h6.__s, $4)))) {
                        (u6.__v != t5.__v && ((h6.props = k5), (h6.state = h6.__s), (h6.__d = false)),
                            (u6.__e = t5.__e),
                            (u6.__k = t5.__k),
                            u6.__k.some(function (n5) {
                                n5 && (n5.__ = u6);
                            }),
                            w.push.apply(h6.__h, h6._sb),
                            (h6._sb = []),
                            h6.__h.length && e5.push(h6));
                        break n;
                    }
                    (null != h6.componentWillUpdate && h6.componentWillUpdate(k5, h6.__s, $4),
                        x6 &&
                            null != h6.componentDidUpdate &&
                            h6.__h.push(function () {
                ...
                ((h6.state = h6.__s),
                    null != h6.getChildContext && (i5 = m(m({}, i5), h6.getChildContext())),
                    x6 && !p6 && null != h6.getSnapshotBeforeUpdate && (d6 = h6.getSnapshotBeforeUpdate(v5, y6)),
                    (A6 = null != s5 && s5.type === S && null == s5.key ? E(s5.props.children) : s5),
                    (f6 = L(n4, g(A6) ? A6 : [A6], u6, t5, i5, r5, o5, e5, f6, c5, a5)),
                    (h6.base = u6.__e),
                    (u6.__u &= -161),
                    h6.__h.length && e5.push(h6),
                    _6 && (h6.__E = h6.__ = null));
            }
            catch (n5) {
                if (((u6.__v = null), c5 || null != o5))
                    if (n5.then) {
    ...
    function G(u6, t5, i5, r5, o5, e5, f6, c5, a5) {
        ...
        if (("svg" == x6 ? (o5 = "http://www.w3.org/2000/svg") : "math" == x6 ? (o5 = "http://www.w3.org/1998/Math/MathML") : o5 || (o5 = "http://www.w3.org/1999/xhtml"), null != e5)) {
            for (s5 = 0; s5 < e5.length; s5++)
                if ((y6 = e5[s5]) && "setAttribute" in y6 == !!x6 && (x6 ? y6.localName == x6 : 3 == y6.nodeType)) {
                    ((u6 = y6), (e5[s5] = null));
                    break;
                }
        }
    ...
    function R(u6, t5, i5) {
        var r5, o5, e5, f6;
        (t5 == document && (t5 = document.documentElement),
            l.__ && l.__(u6, t5),
            (o5 = (r5 = "function" == typeof i5) ? null : (i5 && i5.__k) || t5.__k),
            (e5 = []),
            (f6 = []),
            q(t5, (u6 = ((!r5 && i5) || t5).__k = k(S, null, [u6])), o5 || d, d, t5.namespaceURI, !r5 && i5 ? [i5] : o5 ? null : t5.firstChild ? n.call(t5.childNodes) : null, e5, !r5 && i5 ? i5 : o5 ? o5.__e : t5.firstChild, r5, f6),
            D(e5, u6, f6));
    }
    function X(n4) {
        function l6(n5) {
            ...
            return (
                this.getChildContext ||
                    ...
                    (this.shouldComponentUpdate = function (n6) {
                        this.props.value != n6.value &&
                            u6.forEach(function (n7) {
                                ((n7.__e = true), A(n7));
                            });
                    }),
    ...
    ((n = w.slice),
        (l = {
            __e: function (n4, l6, u6, t5) {
                for (var i5, r5, o5; (l6 = l6.__); )
                    if ((i5 = l6.__c) && !i5.__)
                        try {
    ...
    function h2(n4, u6, i5) {
        ...
        if (
            ...
            !o5.__c &&
                ((o5.__ = [
                    i5 ? i5(u6) : D2(void 0, u6),
                    function (n5) {
                        var t5 = o5.__N ? o5.__N[0] : o5.__[0],
                            r5 = o5.t(t5, n5);
    ...
    ((c2.__b = function (n4) {
        ...
        (c2.__r = function (n4) {
            ...
            (i5 &&
                (u3 === r2
                    ? ((i5.__h = []),
                      (r2.__h = []),
                      i5.__.some(function (n5) {
                          (n5.__N && (n5.__ = n5.__N), (n5.u = n5.__N = void 0));
                      }))
                    : (i5.__h.some(z2), i5.__h.some(B2), (i5.__h = []), (t2 = 0))),
                (u3 = r2));
        }),
        (c2.diffed = function (n4) {
            ...
            (t5 &&
                t5.__H &&
                (t5.__H.__h.length && ((1 !== f3.push(t5) && i2 === c2.requestAnimationFrame) || ((i2 = c2.requestAnimationFrame) || w2)(j2)),
                t5.__H.__.some(function (n5) {
        ...
        (c2.__c = function (n4, t5) {
            (t5.some(function (n5) {
                try {
                    (n5.__h.some(z2),
                        (n5.__h = n5.__h.filter(function (n6) {
                            return !n6.__ || B2(n6);
                        })));
                }
                catch (r5) {
    ...
    (((M2.prototype = new C()).isPureReactComponent = true),
        (M2.prototype.shouldComponentUpdate = function (n4, t5) {
    ...
    function V2(n4, t5, e5) {
        return (
            n4 &&
                (n4.__c &&
                    n4.__c.__H &&
                    (n4.__c.__H.__.forEach(function (n5) {
                        "function" == typeof n5.__c && n5.__c();
                    }),
                    (n4.__c.__H = null)),
                null != (n4 = g3({}, n4)).__c && (n4.__c.__P === e5 && (n4.__c.__P = t5), (n4.__c.__e = true), (n4.__c = null)),
                (n4.__k =
                    n4.__k &&
                    n4.__k.map(function (n5) {
                        return V2(n5, t5, e5);
                    }))),
            n4
        );
    ...
    function W2(n4, t5, e5) {
        return (
            n4 &&
                ...
                n4.__c && n4.__c.__P === t5 && (n4.__e && e5.appendChild(n4.__e), (n4.__c.__e = true), (n4.__c.__P = e5))),
            n4
        );
    }
    function P3() {
    ...
    function Y(n4) {
        ...
        if (
            ...
            e5.h && e5.h !== r5 && e5.componentWillUnmount(),
            !e5.v)
        ) {
    ...
    ((C.prototype.isReactComponent = true),
        ["componentWillMount", "componentWillReceiveProps", "componentWillUpdate"].forEach(function (t5) {
            Object.defineProperty(C.prototype, t5, {
                configurable: true,
                get: function () {
            ...
            (function (n5) {
                ...
                for (var i5 in t5) {
                    ...
                    if (!(("value" === i5 && "defaultValue" in t5 && null == l6) || (Q2 && "children" === i5 && "noscript" === e5) || "class" === i5 || "className" === i5)) {
                        ...
                        ("defaultValue" === i5 && "value" in t5 && null == t5.value
                            ? (i5 = "value")
                            : "download" === i5 && true === l6
                              ? (l6 = "")
                              : "translate" === c5 && "no" === l6
                                ...
                                : "o" === c5[0] && "n" === c5[1]
                                  ? "ondoubleclick" === c5
                                      ? (i5 = "ondblclick")
                                      : "onchange" !== c5 || ("input" !== e5 && "textarea" !== e5) || X2(t5.type)
                                        ? "onfocus" === c5
                                            ? (i5 = "onfocusin")
                                            : "onblur" === c5
                                              ? (i5 = "onfocusout")
                                        ...
                                        : (c5 = i5 = "oninput")
                                  : o5 && G2.test(i5)
                                    ? (i5 = i5.replace(K2, "-$&").toLowerCase())
                                    : null === l6 && (l6 = void 0),
                            "oninput" === c5 && u6[(i5 = c5)] && (i5 = "oninputCapture"),
                            (u6[i5] = l6));
                    }
                }
                ("select" == e5 &&
                    (u6.multiple &&
                        Array.isArray(u6.value) &&
                        (u6.value = F(t5.children).forEach(function (n6) {
                            n6.props.selected = -1 != u6.value.indexOf(n6.props.value);
                        })),
                    null != u6.defaultValue &&
                        (u6.value = F(t5.children).forEach(function (n6) {
                            n6.props.selected = u6.multiple ? -1 != u6.defaultValue.indexOf(n6.props.value) : u6.defaultValue == n6.props.value;
                        }))),
                    t5.class && !t5.className ? ((u6.class = t5.class), Object.defineProperty(u6, "className", un)) : t5.className && (u6.class = u6.className = t5.className),
                    (n5.props = u6));
            })(n4),
            (n4.$$typeof = q3),
            on && on(n4));
    ...
    Object.defineProperty(l3.prototype, "value", {
        get: function () {
            var i5 = a3(this);
    ...
    Object.defineProperty(p3.prototype, "value", {
        get: function () {
    ...
    Object.defineProperties(l3.prototype, {
        constructor: { configurable: true, value: void 0 },
        type: { configurable: true, value: y4 },
        props: {
            configurable: true,
            get: function () {
                var i5 = this;
    ...
    g5("__r", function (i5, n4) {
        ...
        if (n4.type !== S) {
            ...
            if (o5) {
                o5.__$f &= -2;
                if (void 0 === (r5 = o5.__$u))
                    o5.__$u = r5 = (function (i6, n5) {
                        var r6;
                        j4(
                            function () {
                                r6 = this;
    ...
    function w4(i5, n4, r5, t5) {
        var o5 = n4 in i5 && void 0 === i5.ownerSVGElement,
            e5 = y3(r5),
            f6 = r5.peek();
        return {
            o: function (i6, n5) {
    ...
    function AppInput() {
        ...
        return u2(S, {
            children: u2("div", {
                ...
                id: inputWrapperId,
                children: [
                    u2("label", { for: datePickerInputId, id: datePickerLabelId, className: "sx__date-input-label", children: $app.config.label || $app.translate("Date") }),
                    u2("input", { id: datePickerInputId, tabIndex: $app.datePickerState.isDisabled.value ? -1 : 0, name: $app.config.name || "date", "aria-describedby": datePickerLabelId, value: $app.datePickerState.inputDisplayedValue.value, "data-testid": "date-picker-input", className: "sx__date-input", onClick: handleClick, onKeyUp: handleKeyUp, type: "text" }),
                    u2("button", { type: "button", tabIndex: $app.datePickerState.isDisabled.value ? -1 : 0, "aria-label": $app.translate("Choose Date"), onKeyDown: handleButtonKeyDown, onClick: () => $app.datePickerState.open(), className: "sx__button sx__date-input-chevron-wrapper", children: u2("img", { className: "sx__date-input-chevron", src: img, alt: "" }) })
                ]
            })
        });
    }
    ...
    function MonthViewHeader({ setYearsView }) {
        ...
        return u2(S, {
            children: u2("header", {
                ...
                children: [
                    u2(Chevron, { direction: "previous", onClick: () => setPreviousMonth(), buttonText: $app.translate("Previous month") }),
                    u2("button", { type: "button", className: "sx__button sx__date-picker__month-view-header__month-year", onClick: (event) => handleOpenYearsView(event), children: selectedDateMonthName + " " + datePickerYear }),
                    u2(Chevron, { direction: "next", onClick: () => setNextMonth(), buttonText: $app.translate("Next month") })
                ]
            })
        });
    }
    ...
    function TimeIcon({ strokeColor }) {
        return u2(S, {
            children: u2("svg", {
                ...
                children: [
                    u2("g", { id: "SVGRepo_bgCarrier", "stroke-width": "0" }),
                    u2("g", { id: "SVGRepo_tracerCarrier", "stroke-linecap": "round", "stroke-linejoin": "round" }),
                    u2("g", { id: "SVGRepo_iconCarrier", children: [u2("path", { d: "M12 8V12L15 15", stroke: strokeColor, "stroke-width": "2", "stroke-linecap": "round" }), u2("circle", { cx: "12", cy: "12", r: "9", stroke: strokeColor, "stroke-width": "2" })] })
                ]
            })
        });
    }
            ...
            children: u2("svg", {
                ...
                children: [
                    ...
                    u2("g", {
                        ...
                        children: [
                            u2("path", { d: "M15 7C15 8.65685 13.6569 10 12 10C10.3431 10 9 8.65685 9 7C9 5.34315 10.3431 4 12 4C13.6569 4 15 5.34315 15 7Z", stroke: strokeColor, "stroke-width": "2" }),
                            u2("path", { d: "M5 19.5C5 15.9101 7.91015 13 11.5 13H12.5C16.0899 13 19 15.9101 19 19.5V20C19 20.5523 18.5523 21 18 21H6C5.44772 21 5 20.5523 5 20V19.5Z", stroke: strokeColor, "stroke-width": "2" })
                        ]
                    })
                ]
            })
                    ...
                    u2("g", {
                        ...
                        children: [
                            u2("g", {
                                ...
                                children: [
                                    u2("rect", { x: "12", y: "11", width: "0.01", height: "0.01", stroke: strokeColor, "stroke-width": "2", "stroke-linejoin": "round" }),
                                    u2("path", { d: "M12 22L17.5 16.5C20.5376 13.4624 20.5376 8.53757 17.5 5.5C14.4624 2.46244 9.53757 2.46244 6.5 5.5C3.46244 8.53757 3.46244 13.4624 6.5 16.5L12 22Z", stroke: strokeColor, "stroke-width": "2", "stroke-linejoin": "round" })
                                ]
                            }),
                            u2("defs", { children: u2("clipPath", { id: "clip0_429_11046", children: u2("rect", { width: "24", height: "24", fill: "white" }) }) })
                        ]
                    })
                ]
            })
    ...
    function YearsViewAccordion({ year, setYearAndMonth, isExpanded, expand }) {
        ...
        return u2(S, {
            children: u2("li", {
                ...
                children: [
                    u2("button", { type: "button", className: "sx__button sx__date-picker__years-accordion__expand-button sx__ripple--wide", onClick: () => expand(year), children: year }),
                    isExpanded && u2("div", { className: "sx__date-picker__years-view-accordion__panel", children: yearWithDates.map((month) => u2("button", { type: "button", className: "sx__button sx__date-picker__years-view-accordion__month", onClick: (event) => handleClickOnMonth(event, month), children: toLocalizedMonth(month, $app.config.locale.value) })) })
                ]
            })
        });
    }
    ...
    function AppPopup({ wrapperEl }) {
        ...
        const classList = T2(() => {
            const returnValue = [POPUP_CLASS_NAME, $app.datePickerState.isDark.value ? "is-dark" : "", $app.config.teleportTo ? "is-teleported" : ""];
            ...
            return returnValue;
        }, [$app.datePickerState.isDark.value, $app.config.placement, $app.config.teleportTo]);
        ...
        return u2(S, {
            children: u2("div", { style: $app.config.teleportTo ? fixedPositionStyle : void 0, "data-testid": "date-picker-popup", className: classList.join(" "), children: datePickerView === DatePickerView.MONTH_DAYS ? u2(MonthView, { seatYearsView: () => setDatePickerView(DatePickerView.YEARS) }) : u2(YearsView, { setMonthView: () => setDatePickerView(DatePickerView.MONTH_DAYS) }) })
        });
    }
    function AppWrapper({ $app }) {
        ...
        if ($app.config.teleportTo) appPopupJSX = $2(appPopupJSX, $app.config.teleportTo);
    ...
    function ViewSelection() {
        ...
        return u2("div", {
            ...
            children: [
                u2("label", { for: viewSelectId, id: viewLabelId, className: "sx__view-selection-label", children: $app.translate("View") }),
                u2("button", { id: viewSelectId, type: "button", "aria-describedby": viewLabelId, "aria-label": $app.translate("Select View"), className: "sx__view-selection-selected-item sx__ripple", onClick: () => setIsOpen(!isOpen), onKeyDown: handleSelectedViewKeyDown, children: [selectedViewLabel, u2("img", { className: "sx__view-selection-chevron", src: img, alt: "" })] }),
                isOpen &&
                    u2("ul", {
    ...
    function ForwardBackwardNavigation() {
        ...
        return u2(S, {
            children: u2("div", {
                ...
                "aria-live": "polite",
                children: [
                    u2(Chevron, { disabled: !!($app.config.minDate.value && dateFromDateTime((_a = rangeEndMinusOneRange === null || rangeEndMinusOneRange === void 0 ? void 0 : rangeEndMinusOneRange.toString()) !== null && _a !== void 0 ? _a : "") < $app.config.minDate.value.toString()), onClick: () => navigate("backwards"), direction: "previous", buttonText: $app.translate("Previous period") }),
                    u2(Chevron, { disabled: !!($app.config.maxDate.value && rangeStartPlusOneRange && dateFromDateTime(rangeStartPlusOneRange.toString()) > $app.config.maxDate.value.toString()), onClick: () => navigate("forwards"), direction: "next", buttonText: $app.translate("Next period") })
                ]
            })
        });
    }
    ...
    function TimeGridEvent({ calendarEvent, dayBoundariesDateTime, isCopy, setMouseDown }) {
        ...
        const localizeArgs = [$app.config.locale.value, { hour: "numeric", minute: "numeric" }];
        ...
        const handleStartDrag = (uiEvent) => {
            ...
            if ((_a2 = calendarEvent._options) === null || _a2 === void 0 ? void 0 : _a2.disableDND) return;
                    ...
                    children: u2("div", {
                        ...
                        children: [
                            !customComponent &&
                                ...
                                u2(S, {
                                    children: [
                                        isCompact && calendarEvent.title && u2("div", { className: "sx__title-and-time-compact", children: [u2("div", { className: "sx__time-grid-event-title", children: calendarEvent.title }), u2("div", { className: "sx__time-grid-event-time", children: timeFn(calendarEvent.start, $app.config.locale.value) })] }),
                                        !isCompact && calendarEvent.title && u2("div", { className: "sx__time-grid-event-title", children: calendarEvent.title }),
                                        (!isCompact || (isCompact && !calendarEvent.title)) && u2("div", { className: "sx__time-grid-event-time", children: [u2(TimeIcon, { strokeColor: eventCSSVariables.iconStroke }), getEventTime(calendarEvent.start, calendarEvent.end)] }),
                                        calendarEvent.people && calendarEvent.people.length > 0 && u2("div", { className: "sx__time-grid-event-people", children: [u2(UserIcon, { strokeColor: eventCSSVariables.iconStroke }), concatenatePeople(calendarEvent.people)] }),
                                        calendarEvent.location && u2("div", { className: "sx__time-grid-event-location", children: [u2(LocationPinIcon, { strokeColor: eventCSSVariables.iconStroke }), calendarEvent.location] })
                                    ]
                                }),
                            hasCustomContent &&
                                u2("div", {
                            ...
                            $app.config.plugins.resize && !((_e2 = calendarEvent._options) === null || _e2 === void 0 ? void 0 : _e2.disableResize) && u2("div", { className: "sx__time-grid-event-resize-handle", onMouseDown: startResize, onTouchStart: startResize })
                        ]
                    })
                }),
                eventCopy && u2(TimeGridEvent, { calendarEvent: eventCopy, isCopy: true, setMouseDown, dayBoundariesDateTime })
            ]
        });
    }
    var sortEventsByStartAndEnd = (a5, b5) => {
        if (a5.start.toString() === b5.start.toString()) {
            if (a5.end.toString() < b5.end.toString()) return 1;
            if (a5.end.toString() > b5.end.toString()) return -1;
            return 0;
        }
        if (a5.start.toString() < b5.start.toString()) return -1;
        if (a5.start.toString() > b5.start.toString()) return 1;
        return 0;
    };
            ...
            if (concurrentEventsCache.length && (!nextEvent || (everyConcurrentEventEndsBeforeNextEvent && !currentEventOverlapsWithNextEvent && !areBothEventsZeroMinutes))) {
                ...
                for (let ii2 = 0; ii2 < concurrentEventsCache.length; ii2++) {
                    ...
                    const NupcomingConcurrentEvents = concurrentEventsCache.filter((cachedEvent, index) => {
                        if (cachedEvent === currentEvent || index < ii2) return false;
    ...
    var getClickDateTime = (e5, $app, dayStartDateTime) => {
        if (!(e5.target instanceof HTMLElement)) return;
    ...
    function TimeGridDay({ calendarEvents, date, backgroundEvents }) {
        ...
        return u2("div", {
            ...
            onClick: (e5) => handleOnClick(e5, $app.config.callbacks.onClickDateTime),
            onDblClick: (e5) => handleOnClick(e5, $app.config.callbacks.onDoubleClickDateTime),
            "aria-label": getLocalizedDate$1(date, $app.config.locale.value),
            onMouseLeave: () => setMouseDownOnChild(false),
            onMouseUp: handlePointerUp,
            onTouchEnd: handlePointerUp,
            onMouseDown: handleMouseDown,
            children: [backgroundEvents.map((event) => u2(S, { children: u2(TimeGridBackgroundEvent, { backgroundEvent: event, date: date.toString() }) })), eventsWithConcurrency.map((event) => u2(TimeGridEvent, { calendarEvent: event, dayBoundariesDateTime, setMouseDown: setMouseDownOnChild }, event.id))]
        });
    }
    ...
    function TimeAxis() {
        ...
        return u2(S, {
            children: u2("div", {
                ...
                children: gridSteps.map((gridStep, index) => u2("div", { className: "sx__week-grid__hour", children: [hourCustomComponentFn && hourCCIDs.length && u2("div", { "data-ccid": hourCCIDs[index] }), !hourCustomComponentFn && u2("span", { className: "sx__week-grid__hour-text", children: formatter.format(new Date(0, 0, 0, gridStep.hour, gridStep.minute)) })] }))
            })
        });
    }
            ...
            children: u2("div", {
                ...
                children: week.map((date, idx) =>
                    u2("div", {
                        ...
                        children: [weekGridDateCustomComponentFn && u2("div", { "data-ccid": weekGridDateCCIDs[0][idx] }), !weekGridDateCustomComponentFn && u2(S, { children: [u2("div", { className: "sx__week-grid__day-name", children: getDayNameShort(date, $app.config.locale.value) }), u2("div", { className: "sx__week-grid__date-number", children: date.day })] })]
                    })
                )
            })
        });
        ...
        return u2(S, {
            children: [
                u2("div", {
                    ...
                    "data-ccid": customComponentId.current,
                    "data-event-id": calendarEvent.id,
                    onMouseDown: (e5) => createDragStartTimeout(handleStartDrag, e5),
                    onMouseUp: (e5) => setClickedEventIfNotDragging(calendarEvent, e5),
                    onTouchStart: (e5) => createDragStartTimeout(handleStartDrag, e5),
                    onTouchEnd: (e5) => setClickedEventIfNotDragging(calendarEvent, e5),
                    onClick: (e5) => invokeOnEventClickCallback($app, calendarEvent, e5),
                    onDblClick: (e5) => invokeOnEventDoubleClickCallback($app, calendarEvent, e5),
                    onKeyDown: handleKeyDown,
                    ...
                    children: [
                        !customComponent &&
                            ...
                            u2(S, {
                                children: [
                                    hasOverflowLeft && u2("div", { className: "sx__date-grid-event--left-overflow", style: overflowStyles }),
                                    u2("span", { className: "sx__date-grid-event-text", children: [calendarEvent.title, " \xA0", calendarEvent.start instanceof Temporal.ZonedDateTime && u2("span", { className: "sx__date-grid-event-time", children: timeFn(calendarEvent.start, $app.config.locale.value) })] }),
                                    hasOverflowRight && u2("div", { className: "sx__date-grid-event--right-overflow", style: overflowStyles })
                                ]
                            }),
                        hasCustomContent &&
                            u2("div", {
                        ...
                        $app.config.plugins.resize && !((_d = calendarEvent._options) === null || _d === void 0 ? void 0 : _d.disableResize) && !endsAfterWeek && u2("div", { className: "sx__date-grid-event-resize-handle", onMouseDown: startResize, onTouchStart: startResize })
                    ]
                }),
                eventCopy && u2(DateGridEvent, { calendarEvent: eventCopy, gridRow, isCopy: true })
            ]
        });
    }
        ...
        return u2("div", {
            ...
            children: [
                ...
                Object.values(calendarEvents).map((event, index) => {
                    if (event === DATE_GRID_BLOCKER || !event) return u2("div", { className: "sx__date-grid-cell", style: { gridRow: index + 1 }, onMouseDown: handleMouseDown });
    ...
    var WeekWrapper = ({ $app, id }) => {
        ...
        return u2(S, {
            children: u2(AppContext.Provider, {
                value: $app,
                children: u2("div", {
                        ...
                        u2("div", {
                            ...
                            children: u2("div", {
                                ...
                                children: [
                                    ...
                                    u2("div", { className: "sx__date-grid", "aria-label": $app.translate("Full day- and multiple day events"), children: Object.values(week.value).map((day) => u2(DateGridDay, { date: day.date, calendarEvents: day.dateGridEvents, backgroundEvents: day.backgroundEvents }, day.date)) }),
                                    u2("div", { className: "sx__week-header-border" })
                                ]
                            })
                        }),
                        u2("div", {
    ...
    function CalendarHeader() {
        ...
        }, [$app.datePickerState.selectedDate.value, $app.calendarState.range.value, $app.calendarState.isDark.value, $app.calendarState.isCalendarSmall.value, $app.calendarState.range.value, $app.calendarState.view.value, $app.calendarState.isCalendarSmall.value]);
                ...
                u2(S, {
                    children: [
                        u2("div", {
                            ...
                            children: [headerContentLeftPrependId && u2("div", { "data-ccid": headerContentLeftPrependId }), u2(TodayButton, {}), u2(ForwardBackwardNavigation, {}), u2(RangeHeading, {}, $app.config.locale.value), $app.config.showWeekNumbers.value && isDayOrWeekView && u2(WeekNumber, {}), headerContentLeftAppendId && u2("div", { "data-ccid": headerContentLeftAppendId })]
                        }),
                        u2("div", {
                            className: "sx__calendar-header-content",
                            children: [
                                headerContentRightPrependId && u2("div", { "data-ccid": headerContentRightPrependId }),
                                $app.config.plugins.timezoneSelect && $app.config.plugins.timezoneSelect.isEnabled.value && u2($app.config.plugins.timezoneSelect.ComponentFn, { $app: $app }),
                                $app.config.views.value.length > 1 && u2(ViewSelection, {}, keyForRerenderingOnLocaleChange + "-view-selection"),
                                u2(AppWrapper, { $app: datePickerAppSingleton }),
                                headerContentRightAppendId && u2("div", { "data-ccid": headerContentRightAppendId })
                            ]
                        })
                    ]
                })
    ...
    function useWrapperClasses($app) {
        ...
        const [wrapperClasses, setWrapperClasses] = d2([calendarWrapperClass, getClassForView($app)]);
        useSignalEffect(() => {
            ...
            children: u2("div", {
                ...
                children: u2("div", {
                    ...
                    children: u2(AppContext.Provider, {
                        ...
                        children: [
                            u2(CalendarHeader, {}),
                            u2("div", { className: ["sx__view-container", transitionClass].join(" "), id: viewContainerId }),
                            $app.config.plugins.eventModal && $app.config.plugins.eventModal.calendarEvent.value && u2($app.config.plugins.eventModal.ComponentFn, { $app: $app }, (_a = $app.config.plugins.eventModal.calendarEvent.value) === null || _a === void 0 ? void 0 : _a.id)
                        ]
                    })
                })
            })
    ...
    var toDateString = (format, locale) => {
        ...
        if (internationalFormat.test(format)) return format;
    ...
    var createDatePickerState = (config2, selectedDateParam) => {
        ...
        j4(() => {
            var _a2;
            if ((_a2 = config2.listeners) === null || _a2 === void 0 ? void 0 : _a2.onChange) handleOnChange(selectedDate.value);
        });
        return {
    ...
    var createCalendarState = (calendarConfig, timeUnitsImpl, selectedDate) => {
        ...
        const setRange = (date) => {
            ...
            if (newRange.start.toString() === ((_a2 = range.value) === null || _a2 === void 0 ? void 0 : _a2.start.toString()) && newRange.end.toString() === ((_b = range.value) === null || _b === void 0 ? void 0 : _b.end.toString())) return;
    ...
    var CalendarConfigBuilder = class {
        ...
        build() {
            ...
            return new CalendarConfigImpl(
                ...
                typeof this.firstDayOfWeek === "number" ? this.firstDayOfWeek : DEFAULT_FIRST_DAY_OF_WEEK,
    ...
    var createInternalConfig = (config2, plugins) => {
        return new CalendarConfigBuilder()
            .withLocale(config2.locale)
            .withFirstDayOfWeek(config2.firstDayOfWeek)
            .withDefaultView(config2.defaultView)
            .withViews(config2.views)
            .withDayBoundaries(config2.dayBoundaries)
            .withWeekOptions(config2.weekOptions)
            .withCalendars(config2.calendars)
            .withPlugins(plugins)
            .withIsDark(config2.isDark)
            .withIsResponsive(config2.isResponsive)
            .withCallbacks(config2.callbacks)
            .withMinDate(config2.minDate ? config2.minDate.toString() : void 0)
            .withMaxDate(config2.maxDate ? config2.maxDate.toString() : void 0)
            .withMonthGridOptions(config2.monthGridOptions)
            .withMonthAgendaOptions(config2.monthAgendaOptions)
            .withBackgroundEvents(config2.backgroundEvents)
            .withTheme(config2.theme)
            .withTranslations(config2.translations || translations)
            .withWeekNumbers(config2.showWeekNumbers)
            .withTimezone(config2.timezone)
            .withResources(config2.resources)
            .withResourceGridOptions(config2.resourceGridOptions)
            .withSkipAnimations(config2.skipAnimations)
            .build();
    };
    var Month;
    (function (Month2) {
    ...
    var createDatePickerConfig = (config2, dateSelectionCallback) => {
        ...
        return new ConfigBuilder()
            ...
            .withFirstDayOfWeek(config2.firstDayOfWeek)
            .withTimezone(config2.timezone)
            .withMin(config2.minDate)
            .withMax(config2.maxDate)
            .withTeleportTo(teleportTo)
            .withStyle((_b = config2.datePicker) === null || _b === void 0 ? void 0 : _b.style)
    ...
    function MonthGridEvent({ gridRow, calendarEvent, date, isFirstWeek, isLastWeek }) {
        ...
        const handleStartDrag = (uiEvent) => {
            ...
            if (isUIEventTouchEvent(uiEvent)) uiEvent.preventDefault();
            if (!uiEvent.target) return;
            if (!$app.config.plugins.dragAndDrop || ((_a2 = calendarEvent._options) === null || _a2 === void 0 ? void 0 : _a2.disableDND)) return;
        ...
        const classNames = ["sx__event", "sx__month-grid-event", "sx__month-grid-cell"];
        ...
        return u2("div", {
            ...
            role: "button",
            children: [
                !customComponent && !hasCustomContent && u2(S, { children: [calendarEvent.start instanceof Temporal.ZonedDateTime && u2("div", { className: "sx__month-grid-event-time", children: timeFn(calendarEvent.start, $app.config.locale.value) }), u2("div", { className: "sx__month-grid-event-title", children: calendarEvent.title })] }),
                hasCustomContent &&
                    u2("div", {
                        dangerouslySetInnerHTML: {
    ...
    function MonthGridDay({ day, isFirstWeek, isLastWeek }) {
        ...
        const handleMouseDown = (e5) => {
            ...
            if (callback) callback(day.date, e5);
        };
        ...
        return u2("div", {
            ...
            onClick: (e5) => $app.config.callbacks.onClickDate && $app.config.callbacks.onClickDate(day.date, e5),
            ...
            children: [
                ...
                u2("div", {
                    ...
                    children: [
                        isFirstWeek ? u2(S, { children: monthGridDayNameCustomComponent ? u2("div", { "data-ccid": monthGridDayNameCCID }) : u2("div", { className: "sx__month-grid-day__header-day-name", children: getDayNameShort(dayDate, $app.config.locale.value) }) }) : null,
                        monthGridDateCCID ? u2("div", { "data-ccid": monthGridDateCCID }) : u2("div", { className: dateClassNames.join(" "), children: dayDate.day })
                    ]
                }),
                u2("div", {
                    ...
                    children: Object.values(day.events)
                        ...
                        .map((event, index) => {
                            if (typeof event !== "object") return u2("div", { className: "sx__month-grid-blocker sx__month-grid-cell", style: { gridRow: index + 1 } });
    ...
    function MonthGridWeek({ week, isFirstWeek, isLastWeek }) {
        ...
        return u2("div", {
            ...
            children: [
                $app.config.showWeekNumbers.value && u2("div", { className: "sx__month-grid-week__week-number", children: getWeekNumber(week[0].date, $app.config.firstDayOfWeek.value) }),
                week.map((day) => {
    ...
    function MonthAgendaDay({ day, isActive, setActiveDate, isLeadingOrTrailing }) {
        ...
        return u2("button", {
            ...
            onClick: (e5) => handleClick(e5, $app.config.callbacks.onClickAgendaDate),
            onDblClick: (e5) => handleClick(e5, $app.config.callbacks.onDoubleClickAgendaDate),
            ...
            onKeyDown: handleKeyDown,
            children: [
                u2("div", { children: day.date.day }),
                u2("div", {
                    className: "sx__month-agenda-day__event-icons",
                    children: monthAgendaDateDotsCustomComponent ? u2("div", { "data-ccid": monthAgendaDateDotsCCID }) : u2(S, { children: day.events.slice(0, $app.config.monthAgendaOptions.value.nEventIndicatorsPerDay).map((event) => u2("div", { style: { backgroundColor: `var(--sx-color-${event._color})` }, className: "sx__month-agenda-day__event-icon" }, event.id)) })
                })
            ]
        });
    }
    function MonthAgendaWeek({ week, setActiveDate, activeDate, isLeadingOrTrailing }) {
        ...
        return u2("div", {
            ...
            children: [
                $app.config.showWeekNumbers.value && u2("div", { className: "sx__month-agenda-week__week-number", children: getWeekNumber(Temporal.PlainDate.from(week[0].date), $app.config.firstDayOfWeek.value) }),
                week.map((day, index) => u2(MonthAgendaDay, { setActiveDate, day, isActive: isSameDay(activeDate, day.date), isLeadingOrTrailing: isLeadingOrTrailing === null || isLeadingOrTrailing === void 0 ? void 0 : isLeadingOrTrailing(day.date) }, index + day.date.toString()))
            ]
        });
    }
    ...
    function MonthAgendaEvent({ calendarEvent, customComponentKey = "monthAgendaEvent", customContentKey = "monthAgenda" }) {
        ...
        return u2("div", {
            ...
            onClick: (e5) => onClick(e5),
            onDblClick: (e5) => onDoubleClick(e5),
            onKeyDown,
            tabIndex: 0,
            role: "button",
            children: [
                !customComponent &&
                    ...
                    u2(S, {
                        children: [
                            u2("div", { className: "sx__month-agenda-event__title", children: calendarEvent.title }),
                            u2("div", {
                                className: "sx__month-agenda-event__time sx__month-agenda-event__has-icon",
                                children: [
                                    u2(TimeIcon, { strokeColor: `var(--sx-color-on-${calendarEvent._color}-container)` }),
                                    u2("div", {
                                        dangerouslySetInnerHTML: {
    ...
    function useAgenda($app, createGrid) {
        ...
        y2(() => {
            setAgenda(getAgenda());
        }, [$app.datePickerState.selectedDate.value, $app.calendarEvents.list.value, $app.calendarEvents.filterPredicate.value]);
        return agenda;
    }
    var MonthAgendaWrapper = ({ $app, id }) => {
        ...
        return u2(AppContext.Provider, {
            value: $app,
            children: u2("div", {
                id,
                className: "sx__month-agenda-wrapper",
                children: [
                    u2(MonthAgendaDayNames, { week: agenda.weeks[0] }),
                    u2("div", { className: "sx__month-agenda-weeks", children: agenda.weeks.map((week, index) => u2(MonthAgendaWeek, { week, setActiveDate: (date) => ($app.datePickerState.selectedDate.value = date), activeDate: $app.datePickerState.selectedDate.value, isLeadingOrTrailing: (date) => date.month !== selectedMonth }, index)) }),
                    u2(MonthAgendaEvents, { events: ((_a = agenda.weeks.flat().find((day) => isSameDay(day.date, $app.datePickerState.selectedDate.value))) === null || _a === void 0 ? void 0 : _a.events) || [] }, $app.datePickerState.selectedDate.value)
                ]
            })
        });
    };
    ...
    var WeekAgendaWrapper = ({ $app, id }) => {
        ...
        return u2(AppContext.Provider, {
            ...
            children: u2("div", {
                ...
                children: [
                    u2("div", { className: "sx__week-agenda-header", children: [u2(MonthAgendaDayNames, { week: agenda.weeks[0] }), u2("div", { className: "sx__month-agenda-weeks", children: agenda.weeks.map((week, index) => u2(MonthAgendaWeek, { week, setActiveDate: (date) => ($app.datePickerState.selectedDate.value = date), activeDate: $app.datePickerState.selectedDate.value }, index)) })] }),
                    u2(MonthAgendaEvents, { events: ((_a = agenda.weeks.flat().find((day) => isSameDay(day.date, $app.datePickerState.selectedDate.value))) === null || _a === void 0 ? void 0 : _a.events) || [], customComponentKey: "weekAgendaEvent", customContentKey: "weekAgenda" }, $app.datePickerState.selectedDate.value)
                ]
            })
        });
    };
            ...
            children: u2("div", {
                ...
                children:
                    daysWithEvents.length === 0
                        ? u2("div", { className: "sx__list-no-events", children: $app.translate("No events") })
                              ...
                              u2(
                                  "div",
                                  {
                                      ...
                                      children: [
                                          ...
                                          u2("div", {
                                              ...
                                              children: day.events.map((event) => {
                                                  ...
                                                  return u2(
                                                      ...
                                                      {
                                                          className: classNames.join(" "),
                                                          onClick: (e5) => handleEventClick(e5, event),
                                                          onDblClick: (e5) => handleEventDoubleClick(e5, event),
                                                          onKeyDown: (e5) => handleEventKeyDown(e5, event),
                                                          tabIndex: 0,
                                                          role: "button",
                                                          children: [
                                                              u2("div", {
                                                              ...
                                                              u2("div", { className: "sx__list-event-content", children: [u2("div", { className: "sx__list-event-title", children: event.title }), u2("div", { className: "sx__list-event-times", children: renderEventTimes(event, day.date) })] })
                                                          ]
                                                      },
                                                      event.id
                                                  );
                                          ...
                                          u2("div", { className: "sx__list-day-margin" })
                                      ]
                                  },
                                  day.date
                              )
    ...
    function Ge(e5, n4 = 1) {
        const t5 = Uo / n4,
            [o5, r5] = divModTrunc(e5, t5);
        return [o5, r5 * n4];
    }
    function bigNanoToNumber(e5, n4 = 1, t5) {
        const [o5, r5] = e5,
            [i5, a5] = divModTrunc(r5, n4);
    ...
    function checkIsoDateTimeInBounds(e5) {
        const n4 = clampProp(e5, "isoYear", wr, Fr, 1),
            t5 = n4 === wr ? 1 : n4 === Fr ? -1 : 0;
        return (
            t5 &&
    ...
    function isoArgsToEpochMilli(...e5) {
        const [n4, t5] = isoToLegacyDate(...e5),
            o5 = n4.valueOf();
        if (!isNaN(o5)) {
            return o5 - t5 * ko;
        }
    ...
    function isoToLegacyDate(e5, n4 = 1, t5 = 1, o5 = 0, r5 = 0, i5 = 0, a5 = 0) {
        const s5 = e5 === wr ? 1 : e5 === Fr ? -1 : 0,
            c5 = /* @__PURE__ */ new Date();
    ...
    function epochNanoToIso(e5, n4) {
        ...
        o5 < 0 && ((o5 += Uo), (t5 -= 1));
        const [r5, i5] = divModFloor(o5, Qe),
            [a5, s5] = divModFloor(i5, Yo);
        return epochMilliToIso(t5 * ko + r5, a5, s5);
    }
    function epochMilliToIso(e5, n4 = 0, t5 = 0) {
        const o5 = Math.ceil(Math.max(0, Math.abs(e5) - Pr) / ko) * Math.sign(e5),
            r5 = new Date(e5 - o5 * ko);
    ...
    function computeJapaneseEraParts(e5) {
        ...
        const t5 = hashIntlFormatParts(Ci(rr), n4),
            { era: o5, eraYear: r5 } = parseIntlYear(t5, rr);
        return [o5, r5];
    }
    ...
    function constrainIsoDateFields(e5, n4) {
        const { isoYear: t5 } = e5,
            o5 = clampProp(e5, "isoMonth", 1, computeIsoMonthsInYear(), n4);
        return {
            isoYear: t5,
            isoMonth: o5,
    ...
    function Me(e5) {
        const n4 = normalizeOptionsOrString(e5, qr),
            t5 = refineChoiceOption(qr, _r, n4, 0);
        if (!t5) {
    ...
    function J3(e5, n4, t5, o5, r5) {
        const i5 = getMaxDurationUnit(o5),
            [a5, s5] = ((e6, n5) => {
        ...
        const [u6, f6, l6] = createMarkerSystem(n4, t5, s5),
            d6 = createMarkerToEpochNano(l6),
            m6 = createMoveMarker(l6),
            h6 = createDiffMarkers(l6),
            g7 = m6(f6, u6, o5);
        isZonedEpochSlots(s5) || (checkIsoDateTimeInBounds(u6), checkIsoDateTimeInBounds(g7));
        const D4 = h6(f6, u6, g7, a5);
        return isUniformUnit(a5, s5)
            ? totalDayTimeDuration(D4, a5)
            : ((e6, n5, t6, o6, r6, i6, a6) => {
                  const s6 = computeDurationSign(e6),
                      [c6, u7] = clampRelativeDuration(o6, gr(t6, e6), t6, s6, r6, i6, a6),
                      f7 = computeEpochNanoFrac(n5, c6, u7);
    ...
    function Ie(e5, n4, t5) {
        ...
        if (6 === a5) {
            o5 = ((e6, n5, t6, o6) => {
                const r6 = he(t6, n5),
                    [i6, a6] = e6(r6),
                    s6 = t6.epochNanoseconds,
                    c6 = getStartOfDayInstantFor(n5, i6),
                    u7 = getStartOfDayInstantFor(n5, a6);
    ...
    function Te(e5, n4) {
        const t5 = e5(n4.timeZone),
            o5 = he(n4, t5),
            [r5, i5] = computeDayInterval(o5),
            a5 = bigNanoToNumber(diffBigNanos(getStartOfDayInstantFor(t5, r5), getStartOfDayInstantFor(t5, i5)), zo, 1);
        if (a5 <= 0) {
            throw new RangeError(fo);
        }
        return a5;
    ...
    function ve(e5, n4) {
        const { timeZone: t5, calendar: o5 } = n4,
            r5 = ((e6, n5, t6) => getStartOfDayInstantFor(n5, e6(he(t6, n5))))(computeDayFloor, e5(t5), n4);
        return _e(r5, t5, o5);
    }
        ...
        return (
            m6 &&
                ...
                (l6 = ((e6, n5, t6, o6, r6, i6, a6, s6) => {
                    ...
                    return e6;
                })(l6, d6, t5, Math.max(6, o5), a5, s5, c5, u6)),
            l6
        );
    }
    ...
    function nudgeDayTimeDuration(e5, n4, t5, o5, r5, i5) {
        const a5 = computeDurationSign(e5),
            s5 = durationFieldsToBigNano(e5),
            c5 = roundBigNano(s5, o5, r5, i5),
            u6 = diffBigNanos(s5, c5),
            f6 = Math.sign(c5[0] - s5[0]) === a5,
            l6 = nanoToDurationDayTimeFields(c5, Math.min(t5, 6));
        return [
            {
                ...e5,
                ...l6
    ...
    function nudgeZonedTimeDuration(e5, n4, t5, o5, r5, i5, a5, s5, c5, u6) {
        const f6 = computeDurationSign(e5) || 1,
            l6 = bigNanoToNumber(durationFieldsToBigNano(e5, 5)),
            d6 = computeNanoInc(o5, r5);
        let m6 = roundByInc(l6, d6, i5);
        const [p6, h6] = clampRelativeDuration(
                a5,
                {
                    ...e5,
                    ...hr
            ...
            g7 = m6 - bigNanoToNumber(diffBigNanos(p6, h6));
        let D4 = 0;
    ...
    function nudgeRelativeDuration(e5, n4, t5, o5, r5, i5, a5, s5, c5, u6) {
        const f6 = computeDurationSign(e5),
            l6 = p5[o5],
            d6 = gr(o5, e5);
        7 === o5 &&
            (e5 = {
        ...
        d6[l6] = m6;
        const [h6, g7] = clampRelativeDuration(a5, d6, o5, r5 * f6, s5, c5, u6),
            D4 = m6 + computeEpochNanoFrac(n4, h6, g7) * f6 * r5,
            T7 = roundByInc(D4, r5, i5),
            I3 = Math.sign(T7 - D4) === f6;
    ...
    function k4(e5, n4) {
        ...
        return (
            ...
            ((e6, n5) => {
                const { sign: t6 } = e6,
                    o6 = -1 === t6 ? negateDurationFields(e6) : e6,
                    { hours: r6, minutes: i5 } = o6,
                    [a5, s5] = divModBigNano(durationFieldsToBigNano(o6, 3), Ro, divModTrunc);
                checkDurationTimeUnit(a5);
                const c5 = formatSubsecNano(s5, n5),
                    u6 = n5 >= 0 || !t6 || c5;
                return (
                    (t6 < 0 ? "-" : "") +
                    "P" +
    ...
    function Se(e5, n4 = 0) {
        ...
        const [t5, o5] = divModFloor(Math.abs(e5), zo),
            [r5, i5] = divModFloor(o5, Zo),
            [a5, s5] = divModFloor(i5, Ro);
    ...
    function formatDurationNumber(e5, n4) {
        return e5 || n4
            ? e5.toLocaleString("fullwide", {
                  useGrouping: 0
              })
            : "";
    }
    function _zonedEpochSlotsToIso(e5, n4) {
        const { epochNanoseconds: t5 } = e5,
            o5 = (n4.R ? n4 : n4(e5.timeZone)).R(t5),
            r5 = epochNanoToIso(t5, o5);
        return {
    ...
    function moveTime(e5, n4) {
        const [t5, o5] = durationFieldsToBigNano(n4, 5),
            [r5, i5] = nanoToIsoTimeAndDay(isoTimeFieldsToNano(e5) + o5);
        return [r5, t5 + i5];
    }
    ...
    function createMarkerSystem(e5, n4, t5) {
        ...
        return isZonedEpochSlots(t5)
            ? [t5, o5, n4(t5.timeZone)]
            : [
                  {
                      ...t5,
                      ...Nt
    ...
    function E4(e5, n4, t5, o5, r5, i5, a5) {
        const s5 = e5(normalizeOptions(a5).relativeTo),
            c5 = Math.max(getMaxDurationUnit(r5), getMaxDurationUnit(i5));
        ...
        const [u6, f6, l6] = createMarkerSystem(n4, t5, s5),
            d6 = createMoveMarker(l6),
            m6 = createDiffMarkers(l6),
            p6 = d6(f6, u6, r5);
        return Oe(m6(f6, u6, d6(f6, p6, i5), c5));
    }
    function V3(e5, n4, t5, o5, r5) {
        const i5 = getMaxDurationUnit(o5),
            [a5, s5, c5, u6, f6] = ((e6, n5, t6) => {
        ...
        const [d6, m6, p6] = createMarkerSystem(n4, t5, f6),
            h6 = createMarkerToEpochNano(p6),
            g7 = createMoveMarker(p6),
            D4 = createDiffMarkers(p6),
            T7 = g7(m6, d6, o5);
        isZonedEpochSlots(f6) || (checkIsoDateTimeInBounds(d6), checkIsoDateTimeInBounds(T7));
        let I3 = D4(m6, d6, T7, a5);
        const M4 = o5.sign,
            N3 = computeDurationSign(I3);
        if (M4 && N3 && M4 !== N3) {
            throw new RangeError(fo);
        }
    ...
    function Ae(e5, n4) {
        ...
        const { offset: o5 } = t5,
            r5 = o5 ? parseOffsetNano(o5) : void 0,
            [, i5, a5] = je(n4);
    ...
    function de(e5, n4, t5) {
        ...
        return (
            n4
                ? o5.calendar === l5 &&
                  (o5 =
                      -271821 === o5.isoYear && 4 === o5.isoMonth
                          ? {
                                ...o5,
                                isoDay: 20,
                                ...Nt
                      ...
                      function parseUnit(e8, r6, i5) {
                          ...
                          if ((i5 && ([a5, o5] = divModFloor(o5, Ao[i5])), void 0 !== e8)) {
                              ...
                              ((s5 = ((e9) => {
                                  ...
                                  (n6 = 1),
                                  r6 && ((o5 = parseSubsecNano(r6) * (Ao[i5] / Ro)), (t5 = 1)));
                          }
                          return a5 + s5;
                      }
                      let n6 = 0,
    ...
    function organizeIsoYearParts(e5) {
        const n4 = parseSign(e5[1]),
            t5 = parseInt(e5[2] || e5[3]);
        if (n4 < 0 && !t5) {
    ...
    function organizeAnnotationParts(e5) {
        ...
        const o5 = [];
        if (
            (e5.replace(Si, (e6, r5, i5) => {
                const a5 = Boolean(r5),
                    [s5, c5] = i5.split("=").reverse();
                if (c5) {
                    if ("u-ca" === c5) {
                        (o5.push(s5), n4 || (n4 = a5));
                    }
            ...
            : n4
              ? ((e6) => {
                    ...
                    return e6
                        .toLowerCase()
                        .split("/")
                        .map((e7, n5) => ((e7.length <= 3 || /\d/.test(e7)) && !/etc|yap/.test(e7) ? e7.toUpperCase() : e7.replace(/baja|dumont|[a-z]+/g, (e8, t5) => ((e8.length <= 2 && !n5) || "in" === e8 || "chat" === e8 ? e8.toUpperCase() : e8.length > 2 || !t5 ? capitalize(e8).replace(/island|noronha|murdo|rivadavia|urville/, capitalize) : e8))))
                        .join("/");
                })(e5)
              : si;
    }
    ...
    function K3(e5, n4, t5, o5, r5, i5) {
        const a5 = e5(normalizeOptions(i5).relativeTo),
            s5 = Math.max(getMaxDurationUnit(o5), getMaxDurationUnit(r5));
        ...
        const [c5, u6, f6] = createMarkerSystem(n4, t5, a5),
            l6 = createMarkerToEpochNano(f6),
            d6 = createMoveMarker(f6);
    ...
    function Ee(e5, n4, t5, o5) {
        const r5 = refineDiffOptions(e5, o5, 3, 5),
            i5 = diffEpochNanos(n4.epochNanoseconds, t5.epochNanoseconds, ...r5);
        return Oe(e5 ? negateDurationFields(i5) : i5);
    }
    function we(e5, n4, t5, o5, r5, i5) {
        const a5 = getCommonCalendarId(o5.calendar, r5.calendar),
            [s5, c5, u6, f6] = refineDiffOptions(t5, i5, 5),
            l6 = o5.epochNanoseconds,
            d6 = r5.epochNanoseconds,
            m6 = compareBigNanos(d6, l6);
        let p6;
        if (m6) {
            if (s5 < 6) {
    ...
    function It(e5, n4, t5, o5, r5) {
        const i5 = getCommonCalendarId(t5.calendar, o5.calendar),
            [a5, s5, c5, u6] = refineDiffOptions(n4, r5, 6),
            f6 = isoToEpochNano(t5),
            l6 = isoToEpochNano(o5),
            d6 = compareBigNanos(l6, f6);
        let m6;
        if (d6) {
            if (a5 <= 6) {
    ...
    function zt(e5, n4, t5, o5, r5) {
        const i5 = getCommonCalendarId(t5.calendar, o5.calendar),
            a5 = refineDiffOptions(n4, r5, 9, 9, 8),
            s5 = e5(i5),
            c5 = moveToDayOfMonthUnsafe(s5, t5),
            u6 = moveToDayOfMonthUnsafe(s5, o5);
    ...
    function diffDateLike(e5, n4, t5, o5, r5, i5, a5, s5, c5 = 6) {
        const u6 = isoToEpochNano(t5),
            f6 = isoToEpochNano(o5);
    ...
    function it(e5, n4, t5, o5) {
        const [r5, i5, a5, s5] = refineDiffOptions(e5, o5, 5, 5),
            c5 = roundByInc(diffTimes(n4, t5), computeNanoInc(i5, a5), s5),
            u6 = {
                ...pr,
    ...
    function diffDateTimesExact(e5, n4, t5, o5, r5) {
        const i5 = isoToEpochNano(n4),
            a5 = isoToEpochNano(t5),
            s5 = compareBigNanos(a5, i5);
        ...
        const [s5, c5, u6] = ((e6, n5, t6, o6) => {
            function updateMid() {
                return (
                    ...
                    (l7 = getSingleInstantFor(e6, f7)),
                    compareBigNanos(s6, l7) === -o6
                );
            }
            const r6 = he(n5, e6),
                i6 = nn(w5, r6),
                ...
                ((t5 =
                    "islamic" === n4
                        ...
                        : e5.era
                              ...
                              .toLowerCase()
                              .replace(/[^a-z0-9]/g, "")),
                "bc" === t5 || "b" === t5 ? (t5 = "bce") : "ad" === t5 || "a" === t5 ? (t5 = "ce") : "beforeroc" === t5 && (t5 = "broc"),
                (t5 = a5[t5] || t5),
                (o5 = r5),
                (r5 = eraYearToYear(o5, i5[t5] || 0)));
        }
        return {
            era: t5,
            eraYear: o5,
    ...
    function computeIntlDateParts(e5) {
        const { year: n4, o: t5, day: o5 } = this.h(e5),
            { u: r5 } = this.l(n4);
    ...
    function computeIntlLeapMonth(e5) {
        const n4 = queryMonthStrings(this, e5),
            t5 = queryMonthStrings(this, e5 - 1),
            o5 = n4.length;
        if (o5 > t5.length) {
    ...
    function createNativeOpsCreator(e5, n4) {
        return (t5) =>
            t5 === l5
                ? e5
                : t5 === or || t5 === rr
                  ? Object.assign(Object.create(e5), {
                        id: t5
                    })
    ...
    function Ne(e5, n4, t5, o5, r5, i5) {
        const a5 = refineCalendarFields(t5, r5, Xo, jo, xo),
            s5 = e5(a5.timeZone),
            [c5, u6, f6] = je(i5),
            l6 = t5.F(a5, fabricateOverflowOptions(c5)),
            d6 = refineTimeBag(a5, c5);
        return _e(
            getMatchingInstantFor(
                ...
                void 0 !== a5.offset ? parseOffsetNano(a5.offset) : void 0,
                u6,
                f6
            ),
            s5,
    ...
    function At(e5, n4, t5) {
        const o5 = refineCalendarFields(e5, n4, Xo, [], O3),
            r5 = mt(t5);
        return jt(
            checkIsoDateTimeInBounds({
    ...
    function De(e5, n4, t5, o5, r5) {
        const { calendar: i5, timeZone: a5 } = t5,
            s5 = e5(i5),
            c5 = n4(a5),
            u6 = [...s5.fields(Xo), ...Lo].sort(),
            f6 = ((e6) => {
                const n5 = he(e6, L2),
                    t6 = Se(n5.offsetNanoseconds),
                    o6 = ji(e6.calendar),
                    [r6, i6, a6] = o6.v(n5),
                    [s6, c6] = o6.q(r6, i6),
                    u7 = formatMonthCode(s6, c6);
                return {
                    ...$i(n5),
                    year: r6,
                    monthCode: u7,
    ...
    function gt(e5, n4, t5, o5) {
        const r5 = e5(n4.calendar),
            i5 = [...r5.fields(Xo), ...O3].sort(),
            a5 = {
    ...
    function ee(e5, n4, t5, o5) {
        const r5 = e5(n4.calendar),
            i5 = r5.fields(Xo).sort(),
            a5 = computeDateEssentials(n4),
            s5 = refineFields(t5, i5),
            c5 = r5.k(a5, s5);
        return r5.F(c5, o5);
    }
    function Wt(e5, n4, t5, o5) {
        const r5 = e5(n4.calendar),
            i5 = r5.fields(Ko).sort(),
            a5 = ((e6) => {
                const n5 = ji(e6.calendar),
                    [t6, o6] = n5.v(e6),
                    [r6, i6] = n5.q(t6, o6);
                return {
                    year: t6,
    ...
    function refineYear(e5, n4) {
        const t5 = getCalendarEraOrigins(e5),
            o5 = ar[e5.id || ""] || {};
    ...
    function ae(e5, n4, t5, o5, r5) {
        const i5 = e5(r5.timeZone),
            a5 = r5.plainTime,
            s5 = void 0 !== a5 ? n4(a5) : void 0,
            c5 = t5(i5);
        let u6;
        return (
            (u6 = s5
                ? getSingleInstantFor(c5, {
                      ...o5,
                      ...s5
                  })
    ...
    function Q3(e5, n4 = an, t5 = 0) {
        const [o5, , , r5] = e5;
        return (i5, a5 = Na, ...s5) => {
            const c5 = n4(r5 && r5(...s5), i5, a5, o5, t5),
                u6 = c5.resolvedOptions();
        ...
        return t5.map(
            (e6) => (
                e6.calendar &&
                    ...
                    })(e6.calendar, n4.calendar, r5),
                o5(e6, n4)
            )
        );
    }
    function ge(e5, n4, t5) {
        const o5 = n4.timeZone,
            r5 = e5(o5),
            i5 = {
                ...he(n4, r5),
                ...(t5 || Nt)
    ...
    var ai = [
        Math.floor,
        (e5) => (hasHalf(e5) ? Math.floor(e5) : Math.round(e5)),
        Math.ceil,
        (e5) => (hasHalf(e5) ? Math.ceil(e5) : Math.round(e5)),
        Math.trunc,
        (e5) => (hasHalf(e5) ? Math.trunc(e5) || 0 : Math.round(e5)),
        (e5) => (e5 < 0 ? Math.floor(e5) : Math.ceil(e5)),
        (e5) => Math.sign(e5) * Math.round(Math.abs(e5)) || 0,
        (e5) => (hasHalf(e5) ? (e5 = Math.trunc(e5) || 0) + (e5 % 2) : Math.round(e5))
    ];
    var si = "UTC";
    var ci = 5184e3;
    ...
    var FixedTimeZone = class {
        ...
        I(e5) {
            return (
                ...
                [isoToEpochNanoWithOffset(e5, this.$)]
            );
        }
        O() {}
    };
    var IntlTimeZone = class {
        constructor(e5) {
            this.nn = ((e6) => {
                function getOffsetSec(e7) {
                    const i5 = clampNumber(e7, o5, r5),
                        [a5, s5] = computePeriod(i5),
                        c5 = n4(a5),
                        u6 = n4(s5);
                ...
                const n4 = on2(e6),
                    t5 = on2(createSplitTuple);
                let o5 = ui,
                    r5 = fi;
                return {
                    tn(e7) {
                        const n5 = getOffsetSec(e7 - 86400),
                            t6 = getOffsetSec(e7 + 86400),
                            o6 = e7 - n5,
                            r6 = e7 - t6;
                        if (n5 === t6) {
                            return [o6];
                    ...
                    O(e7, i5) {
                        ...
                        const u6 = ci * i5,
                            f6 = i5 < 0 ? () => c5 > o5 || ((o5 = a5), 0) : () => s5 < r5 || ((r5 = a5), 0);
                        for (; f6(); ) {
                            const o6 = n4(s5),
                                r6 = n4(c5);
                            if (o6 !== r6) {
        ...
        O(e5, n4) {
            const [t5, o5] = epochNanoToSecMod(e5),
                r5 = this.nn.O(t5 + (n4 > 0 || o5 ? 1 : 0), n4);
            if (void 0 !== r5) {
                return Ge(r5, Ro);
            }
        }
    ...
    var Yi = {
        P(e5, n4, t5) {
            const o5 = mt(t5);
            let r5,
                { years: i5, months: a5, weeks: s5, days: c5 } = n4;
        ...
        F(e5, n4) {
            const t5 = mt(n4),
                o5 = refineYear(this, e5),
                r5 = refineMonth(this, e5, o5, t5),
                i5 = refineDay(this, e5, r5, o5, t5);
        ...
        _(e5, n4) {
            ...
            let o5,
                r5,
                i5,
                a5 = void 0 !== e5.eraYear || void 0 !== e5.year ? refineYear(this, e5) : void 0;
            const s5 = !this.id;
    ...
    var zi = /* @__PURE__ */ Object.assign({}, Zi, {
        ...
        m(e5) {
            ...
            function computeWeeksInYear(e6) {
                const n5 = computeIsoDaysInYear(f6 + e6),
                    t6 = e6 || 1,
                    o6 = computeWeekShift(modFloor(a5 + n5 * t6, 7));
                return (c5 = (n5 + (o6 - s5) * t6) / 7);
            }
            const n4 = this.id ? 1 : 4,
                t5 = computeIsoDayOfWeek(e5),
                o5 = this.dayOfYear(e5),
                r5 = modFloor(t5 - 1, 7),
                i5 = o5 - 1,
                a5 = modFloor(r5 - i5, 7),
                s5 = computeWeekShift(a5);
            let c5,
                u6 = Math.floor((i5 - s5) / 7) + 1,
                f6 = e5.isoYear;
    ...
    var Wi = /* @__PURE__ */ Object.assign({}, Yi, qi, {
        ...
        G(e5, n4, t5) {
            const o5 =
                this.id && "chinese" === computeCalendarIdBase(this.id)
                    ? ((e6, n5, t6) => {
                          if (n5) {
                              switch (e6) {
                                  case 1:
            ...
            const s5 = computeIntlLeapMonth.call(this, r5),
                c5 = i5 === s5;
            ...
            for (let o6 = 0; o6 < 100; o6++) {
                const i6 = r5 - o6,
                    a6 = computeIntlLeapMonth.call(this, i6),
                    s6 = monthCodeNumberToMonth(e5, n4, a6);
    ...
    function createDateTimeFormatClass() {
        ...
        function DateTimeFormatNew(t6, e6 = /* @__PURE__ */ Object.create(null)) {
            to.set(
                this,
                ((t7, e7) => {
                    const n5 = new en2(t7, e7),
                        o5 = n5.resolvedOptions(),
                        r5 = o5.locale,
                        a5 = nn(Object.keys(e7), o5),
                        i5 = on2(createFormatPrepperForBranding),
                        prepFormat = (t8, ...e8) => {
                            if (t8) {
                                if (2 !== e8.length) {
        ...
        const t5 = en2.prototype,
            e5 = Object.getOwnPropertyDescriptors(t5),
            n4 = Object.getOwnPropertyDescriptors(en2);
        for (const t6 in e5) {
            const n5 = e5[t6],
                o5 = t6.startsWith("format") && createFormatMethod(t6);
            "function" == typeof n5.value
                ? (n5.value = "constructor" === t6 ? DateTimeFormatFunc : o5 || createProxiedMethod(t6))
                : o5 &&
                  ((n5.get = function () {
                      if (!to.has(this)) {
                          throw new TypeError(a4);
    ...
    function createFormatMethod(t5) {
        return Object.defineProperties(function (...e5) {
            const n4 = to.get(this),
                [o5, ...r5] = n4(t5.includes("Range"), ...e5);
            return o5[t5](...r5);
        }, r4(t5));
    }
    ...
    var [zn, $n] = createSlotClass(
        ...
        },
        {
            ...
            getTimeZoneTransition(t5, e5) {
                const { timeZone: n4, epochNanoseconds: o5 } = t5,
                    r5 = Me(e5),
                    a5 = L2(n4).O(o5, r5);
                return a5
                    ? $n({
    ...
    var eo = /* @__PURE__ */ Object.defineProperties(
        Object.create(Intl),
        n3({
            DateTimeFormat: _n
        })
